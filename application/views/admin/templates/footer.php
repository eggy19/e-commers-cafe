  ...
  <!-- <script src="<?php echo base_url()?>application/libraries/moment.js"></script>
  <script src="<?php echo base_url()?>application/libraries/tempusdominus-bootstrap-4.min.js"></script> -->
  <script src="<?php echo base_url()?>assets/admin/js/datepicker.js"></script>

  <script>
    $(document).ready({
      setDateRangePicker(".stardate",".enddate")
    });
  </script>
